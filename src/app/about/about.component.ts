...
export class AboutComponent implements OnInit, OnDestroy {
  ...
  sliderContents: any[] = [
    {
      title: 'Research',
      content:
        'We analyze and study  the project so  we can understand the needs of each client.',
      src: 'assets/images/our-work-research-analysis -1.png',
    },
    {
      title: 'Information Architecture',
      content:
        'We interiorize and conceptualize the project   to organize the information and define the structure.',
      src: 'assets/images/our-work-information-architecture 1.png',
    },
    {
      title: 'User Experience (UX)',
      content:
        'We study the user’s interactions and perceptions to guarantee a satisfactory experience.',
      src: 'assets/images/our-work-ui-ux.png',
    },
    {
      title: 'Interface Design (UI)',
      content:
        'We believe the shape and content go together through the inspiration, creativity, detail and interaction.',
      src: 'assets/images/our-work-ui-interface.png',
    },
    {
      title: 'Development',
      content:
        'Our methodology is centered in the use of advanced tools to accomplish an optimal result and a solid product.',
  ...
  showSlides() {
    this.slideIndex++;
    if (this.slideIndex > this.sliderContents.length - 1) {
      this.slideIndex = 0;
    }
